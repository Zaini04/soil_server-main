...
const POSTJoiEmployeeSchema = Joi.object({
    ...
    monthlySalary: Joi.number().messages({
    "any.required": "Monthly Salary is required.",
    "string.empty": "Monthly Salary  cannot be empty."
}),

// monthlyExpense: Joi.number().allow("").messages({
//     "string.base": "Office expense must be a number."
// })
...
const PATCHJoiEmployeeSchema = Joi.object({
...
const GETJoiEmployeeSchema = Joi.object({
...
const EmployeeValidation = POSTJoiEmployeeSchema;

module.exports = {
    EmployeeValidation,
    POSTJoiEmployeeSchema,
    GETJoiEmployeeSchema,
    PATCHJoiEmployeeSchema
};