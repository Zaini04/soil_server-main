...
const { protect , checkAccess, isSuperAdmin, checkActionAccess } = require('../middlewares/protect');
...
router.get('/get-user-roles' , printRequest ,protect,isSuperAdmin, getUserRoles)

router.route('/:id')
    .get(printRequest , protect , isSuperAdmin , getSingleUser)
    .put(printRequest , protect , isSuperAdmin, updateUser)
