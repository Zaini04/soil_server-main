...
router.get("/expense-summary", protect, printRequest, checkActionAccess("company-records", "view"), getCompanyExpenseSummary);
router.post("/export-excel", protect, printRequest, checkActionAccess("company-records", "view"), exportCompanyExpenseExcel);
router.post("/export-pdf", protect, printRequest, checkActionAccess("company-records", "view"), exportCompanyExpensePdf);
